...
<header class="w3-container w3-theme w3-padding" id="myHeader">
  <li class="w3-dropdown-hover">
    ...
    <div class="w3-dropdown-content w3-card-4">
      ...
      <a class="w3-padding-16" href="/media_dirver/feature_encode">Feature Encode</a>
  ...
  <div class="w3-center">
  <h1 class="w3-xxxlarge w3-animate-bottom">Media Driver Web Portal: Feature Encode</h1>
  </div>
</header>
